...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "DerpholeMobile",
            url: "https://github.com/shayne/derphole/releases/download/v0.16.3/DerpholeMobile.xcframework.zip",
            checksum: "fcfdd945e70cdec724a590b8f59f8c89d8e7979ec868413d8e0c064aceaf5916"
        ),
        .target(
            name: "DerpholeTunnel",
