...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "DerpholeMobile",
            url: "https://github.com/shayne/derphole/releases/download/v0.17.0/DerpholeMobile.xcframework.zip",
            checksum: "a4773eb1d557b7a7d4f49747e1ffa523c05230c16aabbb307c080396c5609125"
        ),
        .target(
            name: "DerpholeTunnel",
